...
/* Line 1455 of yacc.c  */
#line 52 "parser.y"
    {display((yyvsp[(1) - (1)].ptr),0);DisplaySymbolTable((yyvsp[(1) - (1)].ptr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 71 "parser.y"
    {(yyval.ptr)=mknode(TYPE,NULL,NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (1)].type_id));if(!strcmp((yyvsp[(1) - (1)].type_id), "int"))(yyval.ptr)->type=INT;if(!strcmp((yyvsp[(1) - (1)].type_id), "float"))(yyval.ptr)->type=FLOAT;if(!strcmp((yyvsp[(1) - (1)].type_id), "char"))(yyval.ptr)->type=CHAR;if(!strcmp((yyvsp[(1) - (1)].type_id), "string"))(yyval.ptr)->type=STRING;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 86 "parser.y"
    {struct node *temp=mknode(INT,NULL,NULL,NULL,yylineno);temp->type_int=(yyvsp[(3) - (4)].type_int);(yyval.ptr)=mknode(ARRAY_DEC, (yyvsp[(1) - (4)].ptr), temp, NULL,yylineno);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 135 "parser.y"
    {(yyval.ptr)=mknode(PPLUS,(yyvsp[(1) - (3)].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,"PPLUS");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 136 "parser.y"
    {(yyval.ptr)=mknode(PLUSASSIGNOP,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"PLUSASSIGNOP");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 138 "parser.y"
    {(yyval.ptr)=mknode(MMINUS,(yyvsp[(1) - (3)].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,"MMINUS");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 139 "parser.y"
    {(yyval.ptr)=mknode(MINUSASSIGNOP,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"MINUSASSIGNOP");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 141 "parser.y"
    {(yyval.ptr)=mknode(STARASSIGNOP,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"STARASSIGNOP");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 143 "parser.y"
    {(yyval.ptr)=mknode(DIVASSIGNOP,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"DIVASSIGNOP");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 150 "parser.y"
    {struct node *temp=mknode(ID,NULL,NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[(3) - (3)].type_id));(yyval.ptr)=mknode(EXP_ELE,(yyvsp[(1) - (3)].ptr),temp,NULL,yylineno);;}
    break;
