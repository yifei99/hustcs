...
GA1    DB  'PEN',7 DUP(0) ,10  	;商品名称及折扣
       DW   35-10,56,70-10,25,?   ;推荐度还未计算
GA2    DB  'BOOK', 6 DUP(0) ,9  	;商品名称及折扣
       DW   12-10,30,25-10,5,?       ;推荐度还未计算
GAN    DB    N-2 DUP('Temp-Value',8,15-10,0,20,0,30-10,0,2,0,?,?)
NUM    DB   10
       DB   ?
	   DB   10 DUP(0)
OLDINT1 DW 0,0
